...
import { authUrl, oppfolgingUrl, underOppfolgingUrl, besvarelseUrl } from "./config";
...
function App() {
  ...
  return (
    <div className="podlet-vta-jobb">
      <Jobb underOppfolging={underOppfolging} oppfolging={oppfolging} besvarelse={besvarelse} />
    </div>
  );
}
